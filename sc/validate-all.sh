...
run_validation "Tests de EdgeCasesTest.t.sol (25 tests)" "forge test --match-path test/EdgeCasesTest.t.sol" "25 passed"
run_validation "Total de tests correctos (80 tests)" "forge test --match-path 'test/*'" "80 tests passed"
...
- Tests de EdgeCasesTest.t.sol (25 tests)
- Total: 80 tests ejecutados
...
if [ $FAILED -eq 0 ]; then
    ...
    echo -e "${GREEN}║  ✅ 80 tests pasando (100% success rate)                      ║${NC}"
