...
run_validation "Tests de EdgeCasesTest.t.sol (44 tests)" "forge test --match-path test/EdgeCasesTest.t.sol" "44 passed"
run_validation "Total de tests correctos (108 tests)" "forge test --match-path 'test/*'" "108 tests passed"
...
if [ $FAILED -eq 0 ]; then
    ...
    echo -e "${GREEN}║  ✅ Contratos compilados y validados                          ║${NC}"
       echo -e "${GREEN}║  ✅ 108 tests pasando (100% success rate)                     ║${NC}"
