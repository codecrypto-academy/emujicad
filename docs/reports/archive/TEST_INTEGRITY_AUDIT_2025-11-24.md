...
Suite result: ok. 40 passed; 0 failed; 0 skipped; finished in 2.08ms (5.06ms CPU time)
...
Suite result: ok. 64 passed; 0 failed; 0 skipped; finished in 2.18ms (12.00ms CPU time)

Ran 2 test suites in 4.49ms (4.26ms CPU time): 104 tests passed, 0 failed, 0 skipped (104 total tests)
```
