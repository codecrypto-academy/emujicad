...
export default function ProfilePage() {
  ...
  console.log('🔵 ProfilePage - Component rendered', { mounted, hasRedirected, isAuthenticated, isAdmin, isLoading });
  
  useEffect(() => {
    console.log('🟢 ProfilePage - useEffect mounted executed');
    setMounted(true)
  }, [])
  ...
  useEffect(() => {
    ...
    // CRITICAL CHANGE: Only redirect if EXPLICITLY not authenticated
    // AND NOT admin (double verification)
  ...
  // CRITICAL CHANGE: Only block if NOT authenticated AND NOT admin
  if (!isAuthenticated && !isAdmin) {
